...
namespace Entity
{
    public class Car
    {
        ...
        public void DrawCar(Graphics g, int objId)
        {
            ...
            Pen p01 = new Pen(Color.DarkGray, 5);
            if (objId == 0)
            {
                g.DrawLine(p01, new Point(10, 150), new Point(10, 100));
                ...
                g.FillEllipse(Brushes.DimGray, 68, 132, 35, 35);
                 g.FillEllipse(Brushes.White, 75, 140, 20, 20);

                 g.DrawEllipse(new Pen(Color.White, 5), 160, 125, 50, 50);
                 g.FillEllipse(Brushes.DimGray, 168, 132, 35, 35);
                 g.FillEllipse(Brushes.White, 175, 140, 20, 20);

                 g.FillRectangle(Brushes.Red, 230, 100, 18, 20);
                 g.DrawLine(p01, new Point(10, 120), new Point(260, 120));
                 g.FillRectangle(Brushes.DodgerBlue, 60, 100, 150, 20);
                 g.FillRectangle(Brushes.Goldenrod, 90, 100, 100, 20);
            ...
            if (objId == 1)
            {
              /*  g.DrawRectangle(p, 40, 30, 80, 60);
                ...
                g.DrawLine(p01, new Point(10, 120), new Point(250, 120));
                g.FillRectangle(Brushes.DodgerBlue, 60, 100, 150, 20);
                g.FillRectangle(Brushes.Goldenrod, 90, 100, 100, 20);
